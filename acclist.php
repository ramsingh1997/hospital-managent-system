...
<tr bgcolor=red><td ><font size=4 color=white>Account Details</font></td></tr>
<form method="post" action="acclist.php">
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        while($row = mysqli_fetch_array($result)){
            echo "<tr>";
                ...
                echo "<td>" . $row['Recp_no'] . "</td>";
                echo "<td>" . $row['Reg_date'] . "</td>";
                echo "<td>" . $row['Medicine_fees'] . "</td>";
                echo "<td>" . $row['Lab_fees'] . "</td>";
                echo "<td>" . $row['Dr_fees'] . "</td>";
...
?>
 ...
 <tr><td align=center><a href=ram.html><input type="button" value="CLOSE"></a></td></tr>
	<tr><td><a href="account.html"><input type="button" value="ADD"></a></td></tr>	
</form>	
</table>
</body>
</html>

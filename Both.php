...
?>
 ...
 <tr><td align=center><input type="button" value="CLOSE"></td></tr>
	<tr><td><a href="patient.html"><input type="button" value="ADD"></a></td></tr>	
</form>	
</table>
<table align=center width=80% cellspacing=0 cellpadding=5>
<!--<tr bgcolor=blue><td align=center><font SIZE=6 color=white>HOSPITAL
...
List</font></td></tr>
<form method="post" action="dlist.php">
<!--<tr><td><table width=750 cellspacing=0 cellpadding=5>
<tr bgcolor=#ccccc><td align="center">Doctor ID </td><td align="center">Doctor
Name</td><td align="center">Specialization</td></tr>-->			
...
?>
 ...
 <tr><td align=center><input type="button" value="CLOSE"></td></tr>
	<tr><td><a href="doct.html"><input type="button" value="ADD"></a></td></tr>	
</form>	
</table>
</body>
</html>
